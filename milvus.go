...
//Demo API : https://github.com/milvus-io/milvus-sdk-go/blob/master/examples/README.md
// basic milvus operation example
var MilvusAddr = `milvus.vm:19530`

func MilvusBuildIndex(schema *entity.Schema) {

}

//collectionName := `gosdk_basic_collection`
func QuerySimilarity(collectionName string) {
